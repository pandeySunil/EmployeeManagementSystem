<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminMainMenu.ascx.cs" Inherits="EmployeeManagementSystem.AdminMainMenu" %>
<asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" style="position:absolute;left:8px; top:91px; height: 20px; width: 188px;"
    ...
    <Items>
       ...
       <%-- <asp:MenuItem NavigateUrl="employees.aspx" Text="Employees" Value="Employees">
        ...
        <asp:MenuItem NavigateUrl="EmployeesList.aspx" Text="Employees" Value="Employees">
        </asp:MenuItem>
